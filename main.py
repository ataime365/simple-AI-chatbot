...
def chat(request: Request, user_input: Annotated[str, Form()]):

    chat_log.append({"role": "user","content": user_input})
    chat_responses.append(user_input)
    # model, system promt and then user promt
...
def create_page(request: Request, user_input: Annotated[str, Form()]):
